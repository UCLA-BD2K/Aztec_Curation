...
function InsertController() {
  var self = this;
  this.institution = function(req, res) {
    self._institution(self, req, res);
  };
  this.language = function(req, res) {
    self._language(self, req, res);
  };
  this.agency = function(req, res) {
    self._agency(self, req, res);
  };
}


InsertController.prototype._institution = function(self, req, res) {
...
InsertController.prototype._language = function(self, req, res) {
...
InsertController.prototype._agency= function(self, req, res) {
